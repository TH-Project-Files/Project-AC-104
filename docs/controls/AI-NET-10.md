# AI-NET-10: Monitor BGP with Automated Route Hijacking Detection
...
*Note: Re-homed from AI-NET-08 in v1.2.0 to resolve an ID collision with the gateway-only egress control.*
