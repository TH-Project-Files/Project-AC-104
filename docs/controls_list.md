...
| **[AI-GOV-10](./controls/AI-GOV-10.md)** | Layer 0: Governance & System Controls | IG 2 | 2-Medium | Require AI Vendor Risk Assessments for all new software purchases |
| **[AI-GOV-11](./controls/AI-GOV-11.md)** | Layer 0: Governance & System Controls | IG 2 | 2-Medium | Develop an AI-specific Incident Response Playbook |
| **[AI-GOV-16](./controls/AI-GOV-16.md)** | Layer 0: Governance & System Controls | IG 2 | 2-Medium | Establish AI-specific change management and evaluation gates requiring regression testing, approvals, and rollback plans for updates to models, prompts, agent tools, or RAG datasets. |
| **[AI-GOV-12](./controls/AI-GOV-12.md)** | Layer 0: Governance & System Controls | IG 3 | 2-Medium | Deploy targeted deepfake and synthetic media detection tooling for high-risk workflows (rather than an org-wide mandate) |
| **[AI-GOV-13](./controls/AI-GOV-13.md)** | Layer 0: Governance & System Controls | IG 3 | 2-Medium | Conduct Continuous Red Teaming against AI defenses |
| **[AI-GOV-14](./controls/AI-GOV-14.md)** | Layer 0: Governance & System Controls | IG 3 | 3-Low | Implement Cryptographic Provenance (e.g., C2PA standards) for all official university executive media to establish verifiable digital trust. |
| **[AI-GOV-15](./controls/AI-GOV-15.md)** | Layer 0: Governance & System Controls | IG 3 | 3-Low | Deploy AI-Driven Behavioral Analytics (UEBA) for baseline anomaly detection |
| **[AI-DET-01](./controls/AI-DET-01.md)** | Layer 0: Governance & System Controls (Detection & Response) | IG 2 | 1-High | Implement AI-specific detections and SOAR playbooks (prompt injection, agent/tool abuse, data exfil via AI, connector compromise) |
| **[AI-USR-01](./controls/AI-USR-01.md)** | Layer 0: User Facing Controls | IG 1 | 1-High | Enable Automated 'First Contact' Safety Tips to warn users when interacting with new or anomalous external senders often used by AI phishing bots. |
| **[AI-USR-02](./controls/AI-USR-02.md)** | Layer 0: User Facing Controls | IG 1 | 1-High | Enforce Targeted Impersonation Protection for High-Value Targets (VIPs) to detect subtle visual or character-based spoofing of key personnel names. |
| **[AI-USR-03](./controls/AI-USR-03.md)** | Layer 0: User Facing Controls | IG 1 | 2-Medium | Advanced AI Phishing Simulations: Update Security Awareness Training to include simulations specifically mimicking high-quality, multilingual LLM-generated phishing models. |
| **[AI-USR-04](./controls/AI-USR-04.md)** | Layer 0: User Facing Controls | IG 1 | 3-Low | Implement Executive Challenge-Response Protocols (e.g., pre-established safe words) for urgent voice/video requests. |
| **[AI-USR-05](./controls/AI-USR-05.md)** | Layer 0: User Facing Controls | IG 1 | 3-Low | Conduct Deepfake-Specific Awareness Training focusing on 'liveness' checks (e.g., asking callers to turn their head) and audio/visual artifact detection. |
| **[AI-USR-06](./controls/AI-USR-06.md)** | Layer 0: User Facing Controls | IG 1 | 3-Low | Train staff on Reverse-Turing Tests to detect AI bots in chat/email |
| **[AI-USR-07](./controls/AI-USR-07.md)** | Layer 0: User Facing Controls | IG 1 | 3-Low | Deploy an Automated Incident Reporting Button to instantly quarantine suspected AI phishing |
...
| **[AI-NET-08](./controls/AI-NET-08.md)** | Layer 3: Network | IG 2 | 1-High | Enforce gateway-only egress for AI model providers by blocking direct API access from general subnets at the firewall and SWG. |
| **[AI-NET-04](./controls/AI-NET-04.md)** | Layer 3: Network | IG 2 | 2-Medium | Upgrade to AI-Enhanced Next-Gen Firewalls (NGFW) for behavioral and realtime threat blocking |
...
| **[AI-TRN-02](./controls/AI-TRN-02.md)** | Layer 4: Transport | IG 2 | 2-Medium | Apply Intelligent Rate Limiting against high-speed port scans |
| **[AI-TRN-03](./controls/AI-TRN-03.md)** | Layer 4: Transport | IG 3 | 2-Medium | Use Deep Packet Inspection (DPI) to identify mis-ported traffic |
| **[AI-TRN-04](./controls/AI-TRN-04.md)** | Layer 4: Transport | IG 3 | 2-Medium | Deploy Stateful Protocol Anomaly Detection (IPS) |
| **[AI-AUTH-01](./controls/AI-AUTH-01.md)** | Layer 5: Access Session | IG 1 | 1-High | Require possession factor before password factor in sign-on to limit brute force password compromise. |
| **[AI-ACC-01](./controls/AI-ACC-01.md)** | Layer 5: Access Session | IG 1 | 2-Medium | Enforce Aggressive Absolute & Idle Timeouts on sensitive apps |
| **[AI-ACC-02](./controls/AI-ACC-02.md)** | Layer 5: Access Session | IG 1 | 2-Medium | Implement Concurrent Login Restrictions |
| **[AI-AUTH-02](./controls/AI-AUTH-02.md)** | Layer 5: Access Session | IG 1 | 2-Medium | Require advanced CAPTCHA on password reset requests to prevent automated abuse. |
| **[AI-AUTH-03](./controls/AI-AUTH-03.md)** | Layer 5: Access Session | IG 1 | 2-Medium | Enable immediate, un-mutable out-of-band notifications for all critical account changes (e.g., password reset, MFA device addition). |
| **[AI-AUTH-04](./controls/AI-AUTH-04.md)** | Layer 5: Access Session | IG 1 | 2-Medium | Enable user enumeration prevention for authentication and account recovery workflows to obscure account existence. |
...
| **[AI-END-03](./controls/AI-END-03.md)** | Layer 6: Endpoint Presentation | IG 2 | 1-High | Implement Autonomous, Real-Time Patch Management and Runtime Exploit Prevention. |
| **[AI-END-04](./controls/AI-END-04.md)** | Layer 6: Endpoint Presentation | IG 2 | 2-Medium | Deploy Advanced Behavioral Telemetry: Implement high-fidelity logging (e.g. Sysmon-style) to capture process creation and network connections used by AI-assisted malware that evades signature-based AV. |
| **[AI-END-05](./controls/AI-END-05.md)** | Layer 6: Endpoint Presentation | IG 2 | 2-Medium | Remove or highly manage local admin and installation rights |
| **[AI-END-06](./controls/AI-END-06.md)** | Layer 6: Endpoint Presentation | IG 2 | 3-Low | Deploy AI-Driven EDR/XDR for behavioral process termination |
| **[AI-END-07](./controls/AI-END-07.md)** | Layer 6: Endpoint Presentation | IG 2 | 3-Low | Utilize File Integrity Monitoring (FIM) for critical OS files |
| **[AI-END-08](./controls/AI-END-08.md)** | Layer 6: Endpoint Presentation | IG 3 | 3-Low | Deploy Data Loss Prevention (DLP) to monitor formatted file exfiltration |
| **[AI-END-09](./controls/AI-END-09.md)** | Layer 6: Endpoint Presentation | IG 3 | 3-Low | Configure Application Allow-listing to block untrusted executables |
| **[AI-MSG-01](./controls/AI-MSG-01.md)** | Layer 6: Messaging/Web | IG 2 | 1-High | Deploy Anomalous Attachment & Rare File Type Filtering to block unusual containers (e.g., ISO, IMG) used by AI-automated malware delivery. |
| **[AI-MSG-02](./controls/AI-MSG-02.md)** | Layer 6: Messaging/Web | IG 2 | 1-High | Implement Behavioral Mailbox Intelligence to baseline user communication patterns (tone, frequency, habits) and flag AI-generated anomalies. |
...
| **[AI-APP-03](./controls/AI-APP-03.md)** | Layer 7: General Usage & AppSec Defense | IG 2 | 2-Medium | Deploy Advanced Bot Management (invisible or behavioral CAPTCHAs) |
| **[AI-APP-04](./controls/AI-APP-04.md)** | Layer 7: General Usage & AppSec Defense | IG 2 | 2-Medium | Conduct regular OSINT gathering (e.g., Google Dorking) to discover shadow authentication portals or legacy logins for the domain, and secure them behind a VPN or firewall. |
| **[AI-APP-05](./controls/AI-APP-05.md)** | Layer 7: General Usage & AppSec Defense | IG 2 | 2-Medium | Utilize a Behavioral Web Application Firewall (WAF) |
| **[AI-APP-06](./controls/AI-APP-06.md)** | Layer 7: General Usage & AppSec Defense | IG 3 | 2-Medium | Implement API Security Gateways with strict rate limiting |
| **[AI-APP-07](./controls/AI-APP-07.md)** | Layer 7: General Usage & AppSec Defense | IG 3 | 2-Medium | Integrate Dynamic Application Security Testing (DAST) into CI/CD |
| **[AI-APP-08](./controls/AI-APP-08.md)** | Layer 7: General Usage & AppSec Defense | IG 3 | 2-Medium | Monitor 3rd-party connections via Cloud Application Security Broker (CASB) |
| **[AI-APP-09](./controls/AI-APP-09.md)** | Layer 7: General Usage & AppSec Defense | IG 3 | 3-Low | Scan your company's code repositories to automatically find and review code that was generated by AI. |
| **[AI-LLM-01](./controls/AI-LLM-01.md)** | Layer 7: Internal LLMs & Agentics | IG 1 | 2-Medium | Put strict network filters around your internal AI models so hackers can't steal or copy the AI's core logic. |
...
| **[AI-LLM-09](./controls/AI-LLM-09.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Create strict 'allow-lists' so AI agents can only talk to approved websites or internal systems. |
| **[AI-LLM-10](./controls/AI-LLM-10.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Thoroughly test and review the code and instructions for AI agents before letting them run in the real world. |
| **[AI-LLM-11](./controls/AI-LLM-11.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Continuously scan and classify sensitive company data so you know exactly what information AI tools might access. |
| **[AI-LLM-12](./controls/AI-LLM-12.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Put strict safety checks in place when letting AI talk directly to your company databases (like translating plain text into SQL queries). |
| **[AI-LLM-13](./controls/AI-LLM-13.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Ensure that when AI tools talk to each other or use plugins, they prove who they are and only share the minimum necessary data. |
| **[AI-LLM-14](./controls/AI-LLM-14.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Set up alerts to notify security teams if an AI agent starts behaving unexpectedly or out-of-bounds. |
| **[AI-LLM-15](./controls/AI-LLM-15.md)** | Layer 7: Internal LLMs & Agentics | IG 2 | 3-Low | Protect the specialized databases that feed knowledge to your AI (Vector Stores) with encryption and strict access rules. |
| **[AI-LLM-16](./controls/AI-LLM-16.md)** | Layer 7: Internal LLMs & Agentics | IG 3 | 3-Low | Regularly test internal AI systems by having security teams pretend to be hackers (Red Teaming) to find weak spots. |
